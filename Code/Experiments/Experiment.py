...
class Experiment:
    ...
    def run(self):
        ...
        discriminator_optimizer = torch.optim.Adam(self.discriminator.parameters(), lr=self.adaptation_lr, betas=(0.5, 0.999))
        target_encoder_optimizer = torch.optim.Adam(self.target_encoder.parameters(), lr=self.adaptation_lr, betas=(0.5, 0.999))
